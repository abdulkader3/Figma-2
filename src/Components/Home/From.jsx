  ...
  return (
    <>
      ...
      <section className="w-full h-auto backgraoundPhotos flex flex-col items-center">
            ...
            <div className="w-[250px] md:w-[667px] h-[381px] md:h-[482px] bg-[rgba(196,196,196,0.1)] rounded-[20px] mt-[84px] flex flex-col items-center  ">
              <div className="w-full h-[40px] md:H-[55px] bg-[rgba(196,196,196,0.05)] rounded-tl-[10px] rounded-tr-[10px] mb-[21px] flex justify-center items-center">
            ...
            <div className=" md:block hidden ">
               ...
               <div className=" w-[447px] ">
                 {/* Using InputField component */}
                 <InputField forResponsive='md:w-full md:h-[69px]' placeholder="Okeowo" />
              <InputField forResponsive='md:w-full md:h-[69px]' placeholder="NIK Number" />
              <div className="w-full">
              ...
              <div className="w-[230px] md:w-[538px] md:mt-[50px] h-[50px] bg-[rgba(196,196,196,0.05)] rounded-[10px] rounded-tr-[10px] mb-[21px] flex justify-center items-center">
                <p className="text-[10px] md:text-[14px] font-bold font-montserrat text-center text-[#17C2EC]">
                  Need a certificate for your COVID-19 result? Please click{" "}
                  <span className="underline">here</span>
                </p>
              </div>
